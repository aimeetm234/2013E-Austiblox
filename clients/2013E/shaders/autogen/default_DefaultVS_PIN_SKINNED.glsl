...
void main ()
{
  ...
  vec4 tmpvar_11;
  tmpvar_11.xyz = ((AmbientColor + ((max (0.000000, tmpvar_8) * Lamp0Color) + (max (dot (tmpvar_6, -(Lamp1Dir)), 0.000000) * Lamp1Color))) * tmpvar_7.xyz);
  tmpvar_11.w = tmpvar_7.w;
  vec4 tmpvar_12;
  tmpvar_12.w = 0.000000;
  tmpvar_12.xyz = ((pow ((max (0.000000, dot (normalize ((-(Lamp0Dir) + normalize ((CameraPosition - tmpvar_5)))), tmpvar_6)) * step (0.000000, tmpvar_8)), 50.0000) * Lamp0Color) * 0.900000);
